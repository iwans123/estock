<!-- Button detail modal -->
<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $stock->id }}">
    Detail
</button>

<!-- Modal -->
<div class="modal fade" id="exampleModal{{ $stock->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body row fw-bold">
                ...
                <div class="col-md-6">
                    <table class="table table-borderless">
                        <tr>
                            <td>List</td>
                            <td>: {{ $stock->item->price_code }}</td>
                        </tr>
                        <tr>
                            <td>Harga 1</td>
                            <td>: {{ formatRupiah($stock->item->price_first, true) }}</td>
                        </tr>
                        <tr>
                            <td>Harga 2</td>
